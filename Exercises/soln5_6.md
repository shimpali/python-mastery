...
class TestStock(unittest.TestCase):
    ...
    def test_create_keyword(self):
        s = orig_stock.Stock(name='GOOG', shares=100, price=490.1)
        self.assertEqual(s.name, 'GOOG')
        self.assertEqual(s.shares, 100)
        self.assertEqual(s.price, 490.1)
    ...
    def test_from_row(self):
        s = orig_stock.Stock.from_row(['GOOG', '100', '490.1'])
        self.assertEqual(s.name, 'GOOG')
        self.assertEqual(s.shares, 100)
        self.assertEqual(s.price, 490.1)
    ...
    def test_eq(self):
        a = orig_stock.Stock('GOOG', 100, 490.1)
        b = orig_stock.Stock('GOOG', 100, 490.1)
        self.assertTrue(a == b)
